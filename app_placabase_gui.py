...
SCRIPT_PATH = os.path.join(os.path.dirname(__file__), 'Placa_Base', 'placabase_ARA.py')
CONFIG_PATH = os.path.join(os.path.dirname(__file__), 'Placa_Base', 'placabase_ARA_config.json')
...
class PreviewWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Estimate flange and web thicknesses as proportions of H and B
