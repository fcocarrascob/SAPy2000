...
class FundacionesWidget(QWidget):
    ...
    def init_ui(self):
        ...
        concrete_row.addWidget(self.combo_concrete_material)
        self.btn_reload_concrete = StyledButton("🔄", variant="secondary")
        self.btn_reload_concrete.setMaximumWidth(40)
        self.btn_reload_concrete.setToolTip("Actualizar materiales de hormigón desde SAP2000")
        self.btn_reload_concrete.clicked.connect(self.load_materials)
        self.btn_reload_concrete.setEnabled(False)
        concrete_row.addWidget(self.btn_reload_concrete)
        layout_mat.addRow("Hormigón:", concrete_row)
        
        rebar_mat_row = QHBoxLayout()
        ...
        rebar_mat_row.addWidget(self.combo_rebar_material)
        self.btn_reload_rebar_mat = StyledButton("🔄", variant="secondary")
        self.btn_reload_rebar_mat.setMaximumWidth(40)
        self.btn_reload_rebar_mat.setToolTip("Actualizar materiales de acero desde SAP2000")
        self.btn_reload_rebar_mat.clicked.connect(self.load_materials)
        self.btn_reload_rebar_mat.setEnabled(False)
        rebar_mat_row.addWidget(self.btn_reload_rebar_mat)
        layout_mat.addRow("Acero Refuerzo:", rebar_mat_row)
        ...
        self.combo_corner_bars.setMaximumWidth(200)
        corner_row.addWidget(self.combo_corner_bars)
        self.btn_reload_corner = StyledButton("🔄", variant="secondary")
        self.btn_reload_corner.setMaximumWidth(40)
        self.btn_reload_corner.setToolTip("Actualizar barras disponibles desde SAP2000")
        self.btn_reload_corner.clicked.connect(self.load_materials)
        self.btn_reload_corner.setEnabled(False)
        corner_row.addWidget(self.btn_reload_corner)
        corner_row.addStretch()
        layout_ped.addRow("Barras Esquinas:", corner_row)
        ...
        self.combo_edge_bars.setMaximumWidth(200)
        edge_row.addWidget(self.combo_edge_bars)
        self.btn_reload_edge = StyledButton("🔄", variant="secondary")
        self.btn_reload_edge.setMaximumWidth(40)
        self.btn_reload_edge.setToolTip("Actualizar barras disponibles desde SAP2000")
        self.btn_reload_edge.clicked.connect(self.load_materials)
        self.btn_reload_edge.setEnabled(False)
        edge_row.addWidget(self.btn_reload_edge)
        edge_row.addStretch()
        layout_ped.addRow("Barras Bordes:", edge_row)
    ...
    def on_connection_changed(self, connected):
        ...
        self.btn_reload_concrete.setEnabled(connected)
        self.btn_reload_rebar_mat.setEnabled(connected)
        self.btn_reload_corner.setEnabled(connected)
        self.btn_reload_edge.setEnabled(connected)
